...
String.prototype.replaceAll = function (e, t) {
    ...
    function (e, t) {
        ...
        function e(t, s, n) {
            ...
            l.addEventListener("open", function (e) {
                ...
                i.onopen = function () {
                    ...
                    if (clearTimeout(a), i = null, d) c.readyState = WebSocket.CLOSED, l.dispatchEvent(r("close"));
                    else {
        ...
        return e.prototype.onopen = function () {}, e.prototype.onclose = function () {}, e.prototype.onconnecting = function () {}, e.prototype.onmessage = function () {}, e.prototype.onerror = function () {}, e.debugAll = !1, e.CONNECTING = WebSocket.CONNECTING, e.OPEN = WebSocket.OPEN, e.CLOSING = WebSocket.CLOSING, e.CLOSED = WebSocket.CLOSED, e
        ...
        return e.socket = new Object, e.status = "INIT", e.subscribed = {
                ...
                try {
                    e.socket.onopen = function () {
                        ...
                        if (s = s.slice(5), "x" != messageObject.m && "xm" != messageObject.m && "xt" != messageObject.m)
                            if (console.info('::: ----\x3e received:"' + messageObject.m + '"', messageObject), "touched" != messageObject.m)
                                if ("a" == messageObject.m) jQuery.event.trigger("a", {
                                    address: s,
                                    r: messageObject.r,
                                    y: messageObject.y,
                                    p: messageObject.p
                                ...
                                else if ("oom" == messageObject.m) jQuery.event.trigger("oom", {
                            address: s
                        });
                        else if ("rx" == messageObject.m) jQuery.event.trigger("receivedRx", {
                            address: s,
                            v: messageObject.v
                        }), 0 != e.callbacks.rxembedded && e.callbacks.rxembedded(s, messageObject.v);
                            ...
                            jQuery.event.trigger("videoEnded", {
                                address: s
                            })
                        } else if ("btn" == messageObject.m) 0 != e.callbacks.btnsembedded && e.callbacks.btnsembedded(s, messageObject[n], messageObject[v]), jQuery.event.trigger("btnEvent", {
                            address: s
                        });
                        ...
                        } else jQuery.event.trigger("ping", {
                            address: s,
            ...
            e.subscribed.touch = 1, e.sendMessage('{"m":"registerTouch"}'), e.callbacks.touch = null != t ? t : 0
